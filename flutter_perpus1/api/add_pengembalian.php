...
switch($method) {
    ...
    case 'POST':
        ...
        $tanggal_dikembalikan = new DateTime($data['tanggal_pengembalian']);
        ...
        $sql = "INSERT INTO pengembalian (tanggal_pengembalian, terlambat, denda, peminjaman) 
                VALUES (:tanggal_dikembalikan, :terlambat, :denda, :peminjaman)";
        $stmt = $db->prepare($sql);
        
        try {
            $stmt->execute([
                ':tanggal_dikembalikan' => $data['tanggal_pengembalian'],
                ':terlambat' => $terlambat,
                ':denda' => $denda,
