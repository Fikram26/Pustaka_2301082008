...
class MainDrawer extends StatelessWidget {
        ...
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              color: Color.fromARGB(255, 96, 228, 251),
            ),
            child: Column(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        ...
                        size: 14,
                        color: const Color.fromARGB(255, 96, 228, 251),
                      ),
  ...
  Widget _buildMenuItem({
    ...
    return ListTile(
      leading: Icon(
        icon,
        color: iconColor ?? (isSelected ? const Color.fromARGB(255, 96, 228, 251) : Colors.grey[700]),
        size: 24,
      ),
      title: Text(
        title,
        style: TextStyle(
          color: textColor ?? (isSelected ? const Color.fromARGB(255, 96, 228, 251) : Colors.grey[800]),
          fontSize: 14,
          fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
        ),
      ),
      selected: isSelected,
      selectedTileColor: const Color.fromARGB(255, 96, 228, 251).withOpacity(0.1),
      dense: true,
      onTap: onTap,
    );
  }
