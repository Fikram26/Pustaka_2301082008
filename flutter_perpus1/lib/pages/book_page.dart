...
class _BookPageState extends State<BookPage> {
  final List<Book> books = [
    Book(
      title: 'Lookism',
      author: 'Park Tae Jun',
      imagePath: 'assets/images/looksim.jpg',
      description: 'Park Hyung Suk, kelebihan berat badan dan tidak menarik, diintimidasi dan dilecehkan setiap hari. Tapi keajaiban akan terjadi.',
    ),
    Book(
      title: 'Bumi Manusia',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 100, 224, 255),
