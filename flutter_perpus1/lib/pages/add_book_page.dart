        ...
        if (result['success']) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              ...
              backgroundColor: Color.fromARGB(255, 126, 255, 253),
            ),
          );
        } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 128, 244, 255),
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(255, 135, 237, 255),
