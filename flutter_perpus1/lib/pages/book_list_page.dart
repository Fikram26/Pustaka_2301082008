  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 82, 202, 253),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              color: Color.fromARGB(255, 82, 202, 253),
                                ...
                                children: [
                                  Expanded(
                                    child: TextButton.icon(
                                      ...
                                      icon: const Icon(Icons.edit, color: Color.fromARGB(255, 82, 202, 253)),
                                      label: const Text(
                                        'Edit',
      ...
      floatingActionButton: widget.isAdmin
          ? FloatingActionButton(
              ...
              backgroundColor: Color.fromARGB(255, 82, 202, 253),
